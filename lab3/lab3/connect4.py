...
class Connect4:
    ...
    def deep_copy(self):
        new_connect4 = Connect4(self.width, self.height)
        new_connect4.who_moves = self.who_moves
        new_connect4.game_over = self.game_over
        new_connect4.wins = self.wins
        new_connect4.board = copy.deepcopy(self.board)
        return new_connect4
